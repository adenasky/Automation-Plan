...
| ID: | FORM-N-1 |
| --- | --- |
| Название: | Отправка формы записи на курс "Тестировщик ПО" с невалидным значением "Имя" |
| Предусловия: | Открыта форма записи на странице курса "Тестировщик ПО" - https://netology.ru/programs/qa#/order |
| Шаги: | 1. Ввести невалидное значение в поле "Имя"
|   |2. Ввести валидное значение номера телефона в поле "Телефон"
|   |3. Ввести валидное значение e-mail в поле "Электронная почта"
|   |4. Нажать на кнопку "Записаться". |
| Ожидаемый результат: | Отображается сообщение об ошибке в поле "Имя" |

| ID: | FORM-N-2 |
| --- | --- |
| Название: | Отправка формы записи на курс "Тестировщик ПО" с невалидным значением "Телефон" |
| Предусловия: | Открыта форма записи на странице курса "Тестировщик ПО" - https://netology.ru/programs/qa#/order |
| Шаги: | 1. Ввести валидное значение в поле "Имя"
|   |2. Ввести невалидное значение номера телефона в поле "Телефон"
|   |3. Ввести валидное значение e-mail в поле "Электронная почта"
|   |4. Нажать на кнопку "Записаться". |
| Ожидаемый результат: | Отображается сообщение об ошибке в поле "Телефон" |

| ID: | FORM-N-3 |
| --- | --- |
| Название: | Отправка формы записи на курс "Тестировщик ПО" с невалидным значением "Электронная почта"           |
| Предусловия: | Открыта форма записи на странице курса "Тестировщик ПО" - https://netology.ru/programs/qa#/order |
| Шаги: | 1. Ввести валидное значение в поле "Имя"
|   |2. Ввести валидное значение номера телефона в поле "Телефон"
|   |3. Ввести невалидное значение e-mail в поле "Электронная почта"
|   |4. Нажать на кнопку "Записаться". |
| Ожидаемый результат: | Отображается сообщение об ошибке в поле "Телефон" |
